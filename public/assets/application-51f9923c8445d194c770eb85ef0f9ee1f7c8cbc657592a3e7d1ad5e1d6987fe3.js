...
/*=—÷≈œ»“‹("'";A1;"': '";B1;"', ";≈—À»(Œ—“¿“(—“–Œ ¿(A1);5)=0;"|";""))
  =—÷≈œ»“‹(".";A1;":before{content:'\";B1;"'}")
  =—÷≈œ»“‹("<li><i class=""";A1;"""></i> ";A1;"</li>")*/
  ...
  var getScrollable = function(opts) {
    ...
    if (!scrollable.length) {
      this.each(function() {
        ...
        // and "The scroll-behavior property of the ‚Ä¶ body element is *not* propagated to the viewport."
        // ‚Üí https://drafts.csswg.org/cssom-view/#propdef-scroll-behavior
